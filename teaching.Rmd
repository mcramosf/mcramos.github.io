...
*Answering to anonimous online polls to assess comprehension of basic concepts
...
For more information, find the syllabus of this course [here](files/ResearchMethodsSyllabus_final.pdf). 
...
*Using NetLogo for social simulations [access tutorial](https://www.youtube.com/watch?v=K1Fp0f4RRZU)
*Using Qualtrics for Surveys and survey experiments [access tutorial](https://youtu.be/2oV3rI3AZTM)
...
+ [Full workshop](https://www.youtube.com/watch?list=PLwrOoPWTJPLQVpcVNtuXF-c3CZG9TxyXo&time_continue=2&v=P0KXKQmg5So&feature=emb_logo)

More information about the Social Networks & Health Workshop 

*Intro to Qualtrics
Use of Qualtrics software to implement surveys.Longer versions of the workshops 
